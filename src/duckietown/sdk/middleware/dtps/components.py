...
class DTPSLights(GenericDTPSPublisher, Lights):
...
class DTPSMotors(GenericDTPSPublisher, Motors):
...
class DTPSStateResetFlag(GenericDTPSPublisher, StateResetFlag):
