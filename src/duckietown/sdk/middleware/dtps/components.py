...
class DTPSCollision(Collision, GenericDTPSSubscriber):
    """DTPS collision component."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the DTPS collision component."""
        super().__init__(
            host,
            port,
            robot_name,
    ...
    def _unpack(self, message: dict) -> str:
        return message["data"]
...
class DTPSInertialMeasurementUnit(
    ...
    def _unpack(self, message: dict) -> dict[str, dict[str, float] | float]:
        ...
        linear_acceleration: dict[str, float] = message["linear_acceleration"]
        return {
            "timestamp": timestamp,
            "angular_velocity": {
