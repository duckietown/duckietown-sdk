...
class DTPSConnector:
    ...
    def arun(self, coroutine: Coroutine, *, block: bool = False) -> Any:
        ...
        if block:
            ...
            except (CancelledError, TimeoutError, Exception) as error:
                logger.error(
...
class GenericDTPSSubscriber(GenericSubscriber):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(host=host, robot_name=robot_name, **kwargs)
