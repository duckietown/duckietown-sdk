...
class DB21M(GenericDuckiebot):
    ...
    def _set_state_reset_flag(self, reset_state: bool | None) -> None:  # noqa: FBT001
    ...
    def step(  # noqa: PLR0913
        ...
        *,
        ...
        Args:
            ...
            front_left_rgba: The color of the front left light.
                Type: ``tuple[float, float, float, float] | None``.
                Defaults to `None`.
            front_right_rgba: The color of the front right light.
                Type: ``tuple[float, float, float, float] | None``.
                Defaults to `None`.
            back_left_rgba: The color of the back left light.
                Type: ``tuple[float, float, float, float] | None``.
                Defaults to `None`.
            back_right_rgba: The color of the back right light.
                Type: ``tuple[float, float, float, float] | None``.
                Defaults to `None`.
        ...
        timestamp = time.time()
        self._prepare_world_output(timestamp)
